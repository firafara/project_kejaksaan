...
class _ListAliranPageState extends State<ListAliranPage> {
  ...
  Future<void> _fetchAliran() async {
    final response = await http.get(Uri.parse(Api.Pengawasan));
  ...
  Future<void> _saveStatus(Datum aliran, String status) async {
    try {
      final response = await http.post(
        Uri.parse(Api.UpdateStatusPengawasan),
        body: {
          'id': aliran.id,
          'status': status,
        },
  ...
  Future<void> _handleDelete(Datum aliran) async {
    try {
      final response = await http.post(
        Uri.parse(Api.DeletePengawasan), // Sesuaikan dengan URL endpoint untuk hapus data
        body: {
          'id': aliran.id,
        },
      );
