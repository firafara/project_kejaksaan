...
ModelPidana modelPidanaFromJson(String str) =>
    ModelPidana.fromJson(json.decode(str));

String modelPidanaToJson(ModelPidana data) => json.encode(data.toJson());
...
class ModelPidana {
  ...
  factory ModelPidana.fromJson(Map<String, dynamic> json) => ModelPidana(
